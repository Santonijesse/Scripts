...
# Buffalo Wild Wings — browse menu, navigate to order
# Note: package may be com.buffalowildwings.ecomm — verify with: adb shell pm list packages | grep buffalowild
