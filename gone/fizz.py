...
# Fizz — browse feed, open post
# Note: app may have been rebranded — verify on device
...
driver.find_element(AppiumBy.CLASS_NAME, "android.widget.EditText").send_keys("fz6p")
time.sleep(1)
tap(535, 2400, 3)
tap(535, 1550, 3)
tap(535, 950, 3)
