...
# TrueShort — browse content, open item
# Note: app may have been renamed or removed from Play Store — verify on device
...
driver.find_element(AppiumBy.CLASS_NAME, "android.widget.EditText").send_keys("ts8r")
time.sleep(1)
tap(535, 2400, 3)
tap(535, 1550, 3)
tap(535, 950, 3)
