...
# Speedometer Simple — launch, allow location, view speed display
# Note: package may have changed or app removed. Alt: com.danogentili.speedometer (Speedometer GPS)
# Verify with: adb shell pm list packages | grep speedometer
