...
# Citizen — browse safety alerts, switch to map tab
# Note: CORRECT package is com.sp0n.citizen (README previously had wrong package com.spotcrime.android)
...
options.load_capabilities({
    ...
    "appium:appPackage": "com.sp0n.citizen",
...
driver.find_element(AppiumBy.CLASS_NAME, "android.widget.EditText").send_keys("ct5z")
time.sleep(1)
tap(535, 2400, 3)
tap(535, 1550, 3)
tap(750, 2400, 3)
