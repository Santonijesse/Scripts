...
# Metropolis Parking — browse parking lots, view details
# Note: package uncertain — verify with: adb shell pm list packages | grep metropolis
...
driver.find_element(AppiumBy.CLASS_NAME, "android.widget.EditText").send_keys("mp3t")
time.sleep(1)
tap(535, 2400, 3)
tap(535, 1550, 3)
tap(535, 1000, 3)
