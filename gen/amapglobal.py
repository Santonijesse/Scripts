...
# AMap Global — browse map, search for location
# Note: com.autonavi.minimap is the domestic China package. Global version may not be on Google Play.
# Verify with: adb shell pm list packages | grep autonavi
